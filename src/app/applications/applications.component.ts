...
export class ApplicationsComponent implements OnInit {
  ...
  //       this.pinErrorMessage = 'Error validating PIN. Please try again.';
  //       this.enteredPin = '';
  //     }
  //   );
  // }
  ...
  validatePinAndToggleStatus(): void {
    ...
    this.CompanyDashboardService.validatePin(payload).subscribe(
      ...
      (error: any) => {
        this.isStatusPinValidating = false;
        console.error('PIN validation error:', error);
        this.statusPinErrorMessage = 'Error validating PIN. Please try again.';
        this.statusTogglePin = '';
      }
    );
  }
  ...
  onToggleStatus(job: any): void {
    this.jobToToggle = job;
    this.newToggleStatus = !job.toggleStatus;
    this.statusTogglePin = '';
    this.statusPinErrorMessage = null;
    this.isStatusPinValidating = false;
